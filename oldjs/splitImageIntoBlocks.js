...
// Take an image path as input, split it into blocks of 30 x 20 px, 
// then write out array of average colours into file.
// Assumes Image is 600 x 400.

function splitImageIntoBlocks(imageURL){

    // Blocks are 30 x 20
    
    // 20 blocks across, 20 blocks down.
    
    Jimp.read("output/" + imageURL).then(function (image) {
...
module.exports = splitImageIntoBlocks;